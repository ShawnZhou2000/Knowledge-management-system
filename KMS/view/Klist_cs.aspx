<%@ Page Title="" Language="C#" MasterPageFile="~/components/masterPage.Master" AutoEventWireup="true" CodeBehind="Klist_cs.aspx.cs" Inherits="KMS.view.Klist_cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="sub-title">知识列表-计算机科学</h1>
    <div class="grid">   
        <div class="grid-inner">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Kid" DataSourceID="SqlDataSource1" Width="1870px">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnection %>" ProviderName="<%$ ConnectionStrings:DBConnection.ProviderName %>" SelectCommand="SELECT knowledge.* FROM knowledge WHERE Kcategory = '计算机科学'"></asp:SqlDataSource>
        </div>
    </div>
