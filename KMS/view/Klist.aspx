<%@ Page Title="" Language="C#" MasterPageFile="~/components/masterPage.Master" AutoEventWireup="true" CodeBehind="Klist.aspx.cs" Inherits="KMS.view.Klist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="sub-title">知识列表</h1>
    <div class="grid">   
        <div class="grid-inner">
            <asp:GridView ID="Klistinfo" runat="server" AutoGenerateColumns="False" DataKeyNames="Kid" DataSourceID="SqlDataSource1" Width="1870px">
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnection %>" ProviderName="<%$ ConnectionStrings:DBConnection.ProviderName %>" SelectCommand="SELECT knowledge.* FROM knowledge"></asp:SqlDataSource>
        </div>
    </div>
</asp:Content>
