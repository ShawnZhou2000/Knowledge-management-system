<%@ Page Title="" Language="C#" MasterPageFile="~/components/masterPage.Master" AutoEventWireup="true" CodeBehind="guestMenu_li.aspx.cs" Inherits="KMS.view.guestMenu_li" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="btn-box">
        <a href="Klist_li.aspx">
            <div class="box box-color-1">
                <span class="ripple"></span>
                <p>知识列表</p>
            </div>
        </a>
        <a href="Kquery_li.aspx">
